  ...
  <div id="page-content-wrapper">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form id="addRepair" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <textarea class="form-control" rows="2" id="info" name="info" readonly>${repair.info}</textarea>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-5">
              <div class="input-group input-append date" id="dateRangePicker2">
                <input type="text" class="form-control" id="daterepair2" name="daterepair2" value="${repair.dateOut}" readonly/>
                                <span class="input-group-addon add-on"><span
                                        class="glyphicon glyphicon-calendar"></span></span>
              </div>
            </div>
